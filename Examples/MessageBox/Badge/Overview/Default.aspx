...
<body>
    ...
    <ext:Container runat="server">
        <LayoutConfig>
            <ext:HBoxLayoutConfig DefaultMargins="0 100 0 0" />
        </LayoutConfig>
        <Items>
    ...
    <ext:Container runat="server">
        <LayoutConfig>
            <ext:HBoxLayoutConfig DefaultMargins="0 20 0 0" />
        </LayoutConfig>
        <Items>
    ...
    <ext:Container runat="server">
        <LayoutConfig>
            <ext:HBoxLayoutConfig DefaultMargins="0 30 0 0" />
        </LayoutConfig>
        <Items>
            <ext:Panel runat="server" Width="70" Height="80" Title="Panel 1">
                <Plugins>
                    <ext:Badge 
                        runat="server" 
                        Text="1" 
            ...
            <ext:Panel runat="server" Width="70" Height="80" Title="Panel 2">
                <Plugins>
                    <ext:Badge 
                        runat="server" 
                        Text="2" 
            ...
            <ext:Panel runat="server" Width="70" Height="80" Title="Panel 3">
                <Plugins>
                    <ext:Badge 
                        runat="server" 
                        Text="3" 
            ...
            <ext:Panel runat="server" Width="70" Height="80" Title="Panel 4">
                <Plugins>
                    <ext:Badge 
                        runat="server" 
                        Text="4" 
            ...
            <ext:Panel runat="server" Width="70" Height="80" Title="Panel 5">
                <Plugins>
                    <ext:Badge 
                        runat="server" 
                        Text="5" 
