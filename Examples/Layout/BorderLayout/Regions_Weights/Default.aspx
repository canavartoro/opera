...
<head runat="server">
    ...
    <script runat="server">
        protected void ChangeWeights(object sender, DirectEventArgs e)
        {
            ...
            BorderLayoutPanel.Items[0].Weight = Convert.ToInt32(WestWeight.Number);
            BorderLayoutPanel.Items[1].Weight = Convert.ToInt32(NorthWeight.Number);
            BorderLayoutPanel.Items[2].Weight = Convert.ToInt32(SouthWeight.Number);
            BorderLayoutPanel.Items[3].Weight = Convert.ToInt32(EastWeight.Number);
            X.ControlsScripting = true;

            BorderLayoutPanel.Render(Window1, 0, RenderMode.InsertTo);
        }
    </script>
</head>
<body>
