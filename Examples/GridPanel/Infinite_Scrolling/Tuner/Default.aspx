                    ...
                    <Items>
                        ...
                        <ext:Panel 
                            ...
                            <CustomConfig>
                                <ext:ConfigItem 
                                    Name="log" 
                                    Value="function (m) { if (!this.disabled) { this.body.createChild({html: m}); this.body.dom.scrollTop = 1000000; }}" 
                                    Mode="Raw" />
                            </CustomConfig>
                        </ext:Panel>
                    </Items>
                    <Listeners>
                        <Render Handler="Ext.EventManager.idleEvent.addListener(function() {item.header.removeCls('x-docked-noborder-left x-docked-noborder-right x-docked-noborder-top'); item.updateLayout({isRoot:true});  }, null, {single: true});" Single="true" />
