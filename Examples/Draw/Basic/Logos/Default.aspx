                    ...
                    <Items>
                        <ext:Panel runat="server" Title="Safari" Layout="FitLayout">
                            <Items>
                                <ext:DrawComponent runat="server">
                                    <Gradients>
                                        <ext:Gradient GradientID="sfblackblue" Angle="90">
                                            <Stops>
                                    ...
                                    <Items>
                                        <ext:Sprite Type="Path" Fill="url(#sfblackblue)" Path="<%# SAFARI_PATH %>" AutoDataBind="true" />
                                    </Items>
                                </ext:DrawComponent>
                            </Items>
                        </ext:Panel>
                        ...
                        <ext:Panel runat="server" Title="Firefox" Layout="FitLayout">
                            <Items>
                                <ext:DrawComponent runat="server">
                                    <Gradients>
                                        <ext:Gradient GradientID="ffblackblue" Angle="90">
                                            <Stops>
                                                <ext:GradientStop Offset="0" Color="rgb(33, 33, 33)" />
                                                <ext:GradientStop Offset="100" Color="rgb(156, 178, 248)" />
                                            </Stops>
                                    ...
                                    <Items>
                                        <ext:Sprite Type="Path" Fill="url(#ffblackblue)" Path="<%# FIREFOX_PATH %>" AutoDataBind="true" />
                                    </Items>
                                </ext:DrawComponent>
                            </Items>
                        </ext:Panel>
                        ...
                        <ext:Panel runat="server" Title="Explorer" Layout="FitLayout">
                            <Items>
                                <ext:DrawComponent runat="server">
                                    <Gradients>
                                        <ext:Gradient GradientID="ieblackblue" Angle="90">
                                            <Stops>
                                                <ext:GradientStop Offset="0" Color="rgb(33, 33, 33)" />
                                                <ext:GradientStop Offset="100" Color="rgb(156, 178, 248)" />
                                            </Stops>
                                    ...
                                    <Items>
                                        <ext:Sprite Type="Path" Fill="url(#ieblackblue)" Path="<%# IE_PATH %>" AutoDataBind="true" />
                                    </Items>
                                </ext:DrawComponent>
                            </Items>
                        </ext:Panel>
                        ...
                        <ext:Panel runat="server" Title="Chrome" Layout="FitLayout">
                            <Items>
                                <ext:DrawComponent runat="server">
                                    <Gradients>
                                        <ext:Gradient GradientID="wkblackblue" Angle="90">
                                            <Stops>
                                                <ext:GradientStop Offset="0" Color="rgb(33, 33, 33)" />
                                                <ext:GradientStop Offset="100" Color="rgb(156, 178, 248)" />
                                            </Stops>
                                    ...
                                    <Items>
                                        <ext:Sprite Type="Path" Fill="url(#wkblackblue)" Path="<%# CHROME_PATH %>" AutoDataBind="true" />
                                    </Items>
                                </ext:DrawComponent>
                            </Items>
                        </ext:Panel>
                        ...
                        <ext:Panel runat="server" Title="Opera" Layout="FitLayout">
                            <Items>
                                <ext:DrawComponent runat="server">
                                    <Gradients>
                                        <ext:Gradient GradientID="opblackblue" Angle="90">
                                            <Stops>
                                                <ext:GradientStop Offset="0" Color="rgb(33, 33, 33)" />
                                                <ext:GradientStop Offset="100" Color="rgb(156, 178, 248)" />
                                            </Stops>
                                    ...
                                    <Items>
                                        <ext:Sprite Type="Path" Fill="url(#opblackblue)" Path="<%# OPERA_PATH %>" AutoDataBind="true" />
                                    </Items>
                                </ext:DrawComponent>
                            </Items>
                        </ext:Panel>
