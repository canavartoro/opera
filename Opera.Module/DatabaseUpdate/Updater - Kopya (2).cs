...
namespace MainDemo.Module.DatabaseUpdate
{
    public class Updater : DevExpress.ExpressApp.Updating.ModuleUpdater
    {
        ...
        public override void UpdateDatabaseAfterUpdateSchema()
        {
            ...
            SecuritySystemRole adminRole = ObjectSpace.FindObject<SecuritySystemRole>(new BinaryOperator("Name", DevExpress.ExpressApp.Security.SecurityStrategy.AdministratorRoleName));
        ...
        private void CreateAnonymousAccess()
        {
            ...
            SecurityRole anonymousRole = ObjectSpace.FindObject<SecurityRole>(new BinaryOperator("Name", "Anonymous"));
            ...
            SecurityUser anonymousUser = ObjectSpace.FindObject<SecurityUser>(new BinaryOperator("UserName", "Anonymous"));
