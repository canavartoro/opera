...
namespace Mikrobar.Module.BusinessObjects
{
    ...
    public class StokHareketDetaylari : XPObject
    {

        StokHareketleri fStokHareket;
        [Association(@"StokHareketDetaylari.StokHareket_StokHareketleri"), XmlIgnore()]
        public StokHareketleri StokHareket
        {
            get { return fStokHareket; }
            set
            {
                SetPropertyValue<StokHareketleri>("StokHareket", ref fStokHareket, value);
            }
        }
        ...
        Raflar fHedefRaf;
        [Association(@"_StokHareketDetaylari.HedefRaf_Raflar"), XmlIgnore(),
        ...
        Raflar fKaynakRaf;
        [Association(@"_StokHareketDetaylari.KaynakRaf_Raflar"), XmlIgnore(),
        ...
        public StokHareketDetaylari() { }
        public StokHareketDetaylari(Session session) : base(session) { }
