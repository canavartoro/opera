...
namespace Mikrobar.Module.BusinessObjects
{
    ...
    public class DepoStoklari : XPObject
    {
        ...
        Raflar fRaf;
        [Association(@"DepoStoklari.RafId_Raflar"), NoForeignKey]
        public Raflar Raf
        {
            get { return fRaf; }
        ...
        [Association(@"DepoStoklari.DepoId_Depolar"), NoForeignKey]
        ...
        public DepoStoklari() { }
        public DepoStoklari(Session session) : base(session) { }
