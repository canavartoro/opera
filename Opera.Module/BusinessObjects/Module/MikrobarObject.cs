...
{
    //[NonPersistent, XafDisplayName("Genel Bilgiler"), ModelDefault("ShowCaption", "False")]
    [NonPersistent]
    public abstract class MikrobarObject : XPObject
    {
        public MikrobarObject() : base(Session.DefaultSession) { }
        public MikrobarObject(Session session) : base(session) { }
